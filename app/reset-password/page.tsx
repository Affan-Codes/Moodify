          ...
          {success ? (
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-12 py-2 text-base rounded-xl bg-card bg-opacity-80 border border-primary focus:outline-none focus:ring-2 focus:ring-primary text-black dark:text-white
              ...
              <div>
                ...
                <div className="relative">
                  <Lock className="absolute top-1/2 -translate-y-1/2 left-3 text-muted-foreground size-5" />
                  <Input
                    id="confirmPassword"
                    type="password"
