...
const AboutPage = () => {
  return (
    <div className="container mx-auto px-4 py-24">
      ...
      >
        <h1 className="text-4xl mb-6 font-bold bg-linear-to-r from-primary to-primary/80 bg-clip-text text-transparent">
          About Moodify
        </h1>
        <p className="text-xl to-muted-foreground max-w-3xl mx-auto">
        ...
        {missions.map((mission, index) => (
          ...
          >
            <Card className="p-6 text-center h-full bg-card/50 backdrop-blur supports-backdrop-filter:bg-background/60">
              <div className="flex mb-4 justify-center">{mission.icon}</div>
