        ...
        <Card className="w-full md:w-5/12 max-w-2xl p-8 md:p-10 rounded-3xl shadow-2xl border border-primary/10 bg-card/90 backdrop-blur-lg mt-20">
          ...
          {submitted ? (
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-12 py-2 text-base rounded-xl bg-card opacity-80 border border-primary focus:outline-none focus:ring-2 focus:ring-primary text-black dark:text-white placeholder:text-muted-foreground"
                    value={email}
              ...
              <Button
                className="w-full py-2 text-base rounded-xl font-bold bg-linear-to-r from-primary to-primary/80 shadow-md hover:from-primary/80 hover:to-primary cursor-pointer"
                size={"lg"}
                type="submit"
                disabled={loading}
              >
