        ...
        >
          ...
          >
            <Button
              ...
              className="relative group h-12 px-8 rounded-full bg-linear-to-r from-primary via-primary/90 to-secondary hover:to-primary shadow-lg shadow-primary/20 transition-all duration-500 hover:shadow-xl hover:shadow-primary/30 cursor-pointer"
            >
      ...
      <Dialog open={showDialog} onOpenChange={setShowDialog}>
        <DialogContent className="sm:max-w-[425px] bg-card/80 backdrop-blur-lg">
          <DialogHeader>
            ...
            >
              <div
                className="mx-auto size-16 rounded-full bg-primary/10
          ...
          <div className="flex justify-between items-center mt-8">
            ...
            <Button
              ...
              className="relative group px-6 cursor-pointer"
            >
